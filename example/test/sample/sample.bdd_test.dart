  ...
  group('Sample', () {
    ...
    testWidgets('Counter with examples', (tester) async {
      ...
      for (var example in examples) {
        ...
        // When I increment the <counter>
        await CounterWithExamplesScenario.iIncrementThe(
          tester,
          example['counter']!,
        );
        // Then I should see the counter incremented
    ...
    testWidgets('Counter with parameters', (tester) async {
      ...
      for (var example in examples) {
        ...
        await CounterWithParametersScenario.iIncrementTheCounter(
          tester,
          example['counter']!,
        );
        // Then I should see the result <result>
        await CounterWithParametersScenario.iShouldSeeTheResult(
          tester,
          example['result']!,
        );
      }
